...
<<<<<<< HEAD
    ...
    def save(self, *args, **kwargs):
        """Override save to calculate overall rating from aspects if provided."""
        # If aspect ratings are provided, calculate overall from them
...
<<<<<<< HEAD
    ...
    def contains_spoiler(self):
        ...
        return self.is_spoiler or self.is_auto_detected_spoiler
